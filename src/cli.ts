...
export const VALID_FORMATS = ["table", "json", "html"] as const;
export const VALID_NETWORKS = ["testnet", "mainnet"] as const;
export const VALID_SEPS = ["sep1", "sep10", "sep12", "sep24", "sep38"] as const;
