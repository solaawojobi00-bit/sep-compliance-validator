...
anchor's SEP-1 (`stellar.toml`), SEP-10 (web authentication), and SEP-38
(quotes) endpoints actually behave per spec — not just that the anchor *claims* to
support them.
...
signer, wrong home domain, malformed JWT), and SEP-38 price/quote endpoint
conformance checks. Later phases (SEP-12, SEP-24, mainnet support, CI packaging)
